...
const char* base64Encoding = "YWRtaW46MTIzNA=="; //64-based encoding "admin", "1234"
          ...
          if (currentLine.length() == 0) {
            if (header.indexOf(base64Encoding)>=0){
              ...
              if (header.indexOf("GET /25/on") >= 0) {
                ...
                output26State = "off";
                digitalWrite(output26, LOW);
              } else if (header.indexOf("GET /mode3/start") >= 0) {
              ...
              if (mode3=="off") {
                  client.println("<p><a href=\"/mode3/start\"><button class=\"button\">START</button></a></p>");
              } else {
